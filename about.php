...
<!-- PART 1: ABOUT US CONTENT SPLIT GRID -->
<section class="about-split-section">
    <div class="container">
        <div class="row">
            
            <div class="col-lg-3 col-12">
                <span class="badge-capsule">About us</span>
            </div>
            ...
            <div class="col-lg-6 col-12">
                <div class="mission-content-card scroll-up">
                    ...
                    <div class="mission-list-item">
                        ...
                        <div><strong>Your Comfort is Our Priority:</strong> Our team is dedicated to creating a welcoming and stress-free environment.</div>
                    </div>
                    ...
                    <div class="mission-list-item">
                        ...
                        <div><strong>Excellence in Every Detail:</strong> Advanced treatments, we adhere to the highest standards of quality and precision.</div>
                    </div>
                    ...
                    <div class="mission-list-item">
                        ...
                        <div><strong>Building a Relationship Based on Trust:</strong> That's why we are committed to transparent communication.</div>
                    </div>
...
<section class="values-section">
    <div class="container text-center">
        ...
        <!-- Top Section Header Text Blocks -->
        ...
        <!-- Main Content Array (Image Split + 2x2 Feature Grid Matrix) -->
        <div class="row g-4 align-items-stretch">
            ...
            <!-- Right Side Matrix Column Block -->
...
<!-- START: STICKY PARALLAX CONTAINER SECTION -->
<section class="sticky-parallax-section">
    <div class="container text-center">
        
        <!-- Header Column Block Architecture -->
        <div class="row justify-content-center">
        ...
        <!-- Metric Grid Feature Layout Blocks -->
        <div class="row g-4 text-start">
            ...
            <div class="col-12 col-md-4">
                <div class="feature-white-card scroll-up">
                    ...
                    <p class="feature-card-desc">
                        Patient-centered care means we listen to your concerns, understand your goals & treatment plan to your unique needs. Patient-centered care.
                    </p>
                </div>
            </div>
            ...
            <div class="col-12 col-md-4">
                <div class="feature-white-card scroll-up">
                    ...
                    <div class="feature-card-divider"></div>
                    <p class="feature-card-desc">
                        Every treatment plan is tailored to your individual needs, and we take the time to listen, educate, and support you throughout your dental journey.
                    </p>
                </div>
            </div>
            ...
            <div class="col-12 col-md-4">
                <div class="feature-white-card scroll-up">
                    ...
                    <div class="feature-card-divider"></div>
                    <p class="feature-card-desc">
                        Our staff takes the time to greet you with kindness, answer your questions, and provide the support you need at every stage of your visit.
                    </p>
                </div>
            </div>
    ...
    <div class="container text-center">
        ...
        <div class="faq-accordion-container">
            ...
            <div class="faq-item scroll-up">
                ...
                <div id="faq-collapse-1" class="collapse" data-bs-parent=".faq-accordion-container">
                    <div class="faq-content-body">
                        We recommend routine checkups and cleanings every six months to keep your smile healthy, monitor changes, and prevent any underlying conditions from progressing further.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item scroll-up">
                ...
                <div id="faq-collapse-2" class="collapse" data-bs-parent=".faq-accordion-container">
                    <div class="faq-content-body">
                        Yes, we work closely with a wide range of top dental insurance providers and offer flexible interest-free payment options to ensure your dental treatments fit naturally within your budget.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item scroll-up">
                ...
                <div id="faq-collapse-3" class="collapse" data-bs-parent=".faq-accordion-container">
                    <div class="faq-content-body">
                        Absolutely. We completely specialize in gentle, patient-centered care and offer personalized sedation options to make sure your entire journey remains stress-free and supportive.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item scroll-up">
                ...
                <div id="faq-collapse-4" class="collapse" data-bs-parent=".faq-accordion-container">
                    <div class="faq-content-body">
                        From basic checkups and emergency intervention to advanced cosmetic adjustments, restorative alignment procedures, and root therapies, our practice encompasses all vectors of healthcare solutions.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-item scroll-up">
                ...
                <div id="faq-collapse-5" class="collapse" data-bs-parent=".faq-accordion-container">
                    <div class="faq-content-body">
                        Yes! We are proud to accept new patients into our wellness community. You can easily schedule an initial comprehensive consultation directly through our automated workspace dashboard.
                    </div>
                </div>
            </div>
